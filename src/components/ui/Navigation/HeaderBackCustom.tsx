...
import MaskedView from '@react-navigation/stack/lib/module/views/MaskedView';
    ...
    if (backImage) {
      ...
      return (
        <Image
          ...
          source={require('@react-navigation/stack/lib/module/views/assets/back-icon.png')}
          fadeDuration={0}
        />
      );
    }
      ...
      <MaskedView
        maskElement={
          <View style={styles.iconMaskContainer}>
            <Image
              source={require('@react-navigation/stack/lib/module/views/assets/back-icon-mask.png')}
